...
| **[Version control](https://github.com/Yuichi-Aragi/Version-Control)** | Traçabilité des versions directement dans Obsidian.                                      | Maîtrise des versions (7.| Version |     Date     | Auteur | Nature de la modification |
| :-----: | :----------: | :----- | :------------------------ |
|   0.1   | 08-12-252025 | Vous   | Création du document      |
|         |              |        |                           |est dédiée à la création et à la mise à jour des procédures, politiques et enregistrements.
